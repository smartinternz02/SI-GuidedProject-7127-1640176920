...
def detect(image):
    try:
        ...
        print(people)
        url="https://www.fast2sms.com/dev/bulk?authorization=3LsYVJ5iwbFzHerpyBWamNDOhf8MXKSRPvno9T6UE4qjGcuxCQY4XWlTz3ZedypLusNJbUc6mIEt1VqS&sender_id=FSTSMS&message="+str(people)+" people are in danger.Need to rescue them&language=english&route=p&numbers="+str(9515679692)
